...
class AccessionPropertiesDatastream < ActiveFedora::OmDatastream
  set_terminology do |t|
    ...
    t.disk_num path: 'disk_num', :index_as=>:symbol
    t.accession_num path: 'accession_num', :index_as=>:symbol
    t.disk_label path: 'disk_label', :index_as=>:symbol
    t.disk_image path: 'disk_image', :index_as=>:symbol
  end
